...
//   // setTimeout(function() { console.log('before initsession Works!') }, 3000);
  ...
  // setTimeout(function() { console.log('after initsession Finished Works!') }, 3000);
...
function testAspera() {
  ...
  setTimeout(function() { console.log('testAspera started!') }, 3000);
  ...
  setTimeout(function() { console.log('before startTransfer Works!') }, 3000);
  ...
  setTimeout(function() { console.log('after startTransfer Works!') }, 3000);
...
{/* <input type="button" value={'Init Aspera Connect Start'} onClick={startConnect}/> */}
